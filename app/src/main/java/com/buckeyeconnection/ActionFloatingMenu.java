 ...
 */
public class ActionFloatingMenu extends ViewGroup{
    ...
    public ActionFloatingMenu(Context context) {
        this(context, null);
    }

    public ActionFloatingMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ActionFloatingMenu(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonSize = attr.getInt(R.styleable.FloatingActionsMenu_fab_addButtonSize, ActionFloatingButton.SIZE_NORMAL);
    ...
    public void addButton(ActionFloatingButton button) {
    ...
    public void removeButton(ActionFloatingButton button) {
    ...
    private void createLabels() {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ActionFloatingButton button = (ActionFloatingButton) getChildAt(i);
