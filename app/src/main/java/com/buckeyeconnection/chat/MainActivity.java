...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    initTabLayout();
    LCChatKit.getInstance().setProfileProvider(CustomUserProvider.getInstance(MainActivity.this));
  }
  ...
  private void initTabLayout() {
    ...
    final Fragment[] fragmentList = new Fragment[] {new LCIMConversationListFragment(),
      new ContactFragment(MainActivity.this)};
...
//          EventBus.getDefault().post(new ConversationFragmentUpdateEvent());
  ...
  private void gotoSquareConversation() {
    List<LCChatKitUser> userList = CustomUserProvider.getInstance(MainActivity.this).getAllUsers();
