...
/**
 * Created by dingyinglu on 10/16/16.
 */
public class ActionFloatingButton extends ImageButton{
    ...
    public ActionFloatingButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.ActionFloatingButton, 0, 0);
        mColorNormal = attr.getColor(R.styleable.ActionFloatingButton_fab_colorNormal, getColor(android.R.color.holo_blue_dark));
        mColorPressed = attr.getColor(R.styleable.ActionFloatingButton_fab_colorPressed, getColor(android.R.color.holo_blue_light));
        mColorDisabled = attr.getColor(R.styleable.ActionFloatingButton_fab_colorDisabled, getColor(android.R.color.darker_gray));
        mSize = attr.getInt(R.styleable.ActionFloatingButton_fab_size, SIZE_NORMAL);
        mIcon = attr.getResourceId(R.styleable.ActionFloatingButton_fab_icon, 0);
        mTitle = attr.getString(R.styleable.ActionFloatingButton_fab_title);
        mStrokeVisible = attr.getBoolean(R.styleable.ActionFloatingButton_fab_stroke_visible, true);
        attr.recycle();
    ...
    void updateBackground() {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[] {
                        getResources().getDrawable(mSize == SIZE_NORMAL ? R.mipmap.bg_normal : R.mipmap.bg_mini),
